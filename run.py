...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Exoformer')
    parser.add_argument('--task_name', type=str, required=False, default='long_term_forecast',
                        help='task name, options:[long_term_forecast, short_term_forecast, imputation, classification, anomaly_detection]')
    parser.add_argument('--is_training', type=int, required=False, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=False, default='test', help='model id')
    parser.add_argument('--model', type=str, required=False, default='ValueTS',)
    ...
    parser.add_argument('--t_model', type=int, default=64, help='dimension of model')
    ...
    parser.add_argument('--lamb', type=float, default=0.1, help='alpha')
    parser.add_argument('--gamma', type=float, default=0.5, help='alpha')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            print("\033[91m", "MSE:", mse, " MAE:", mae, "\033[0m")
            print("\033[91m ", '=======================', "\033[0m")
